...
namespace SharePointPnP.PowerShell.ModuleFilesGenerator
{
    internal class HelpFileGenerator
    {
        ...
        private XElement GetCommandElement(Model.CmdletInfo cmdletInfo)
        {
            ...
            {
                detailsElement.Add(new XElement(maml + "description", new XElement(maml + "para", $"* Only available for {cmdletInfo.Platform}.{Environment.NewLine}{Environment.NewLine}{cmdletInfo.Description}")));
            }
            else
            {
