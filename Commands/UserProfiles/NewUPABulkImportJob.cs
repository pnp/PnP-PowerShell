...
namespace SharePointPnP.PowerShell.Commands.UserProfiles
{
    ...
    [CmdletHelp(@"Submit up a new user profile bulk import job.", "See https://dev.office.com/blogs/introducing-bulk-upa-custom-profile-properties-update-api for information on the API and how the bulk import process works.",
