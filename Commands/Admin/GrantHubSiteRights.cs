...
namespace SharePointPnP.PowerShell.Commands.Admin
{
    ...
    [CmdletHelp(@"Grant Permissions to associate sites to Hub Sites for one or more specific users",
    ...
    public class GrantHubSiteRights : PnPAdminCmdlet
    {
        ...
        [Parameter(Mandatory = true, HelpMessage = "One or more usernames that will be given or revoked the permission to associate a site with this Hub Site")]
