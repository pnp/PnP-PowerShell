...
namespace SharePointPnP.PowerShell.Commands.Base
{
    ...
    [CmdletExample(
      ...
      Remarks = @"This will execute any queued actions / changes on the SharePoint Client Side Object Model Context and delay the execution with 10 seconds.", SortOrder = 2)]
