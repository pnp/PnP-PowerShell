    ...
    internal class SPOnlineConnectionHelper
    {
        ...
        private static readonly Lazy<string> PnPPSVersionTagLazy = new Lazy<string>(
            () => {
                ...
                var result = $"NONISV|SharePointPnP|PnPPS/{((AssemblyFileVersionAttribute) coreAssembly.GetCustomAttribute(typeof(AssemblyFileVersionAttribute))).Version.Split('.')[2]}";
                return (result);
            },
            true);
    }
