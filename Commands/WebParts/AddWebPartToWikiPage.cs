...
namespace OfficeDevPnP.PowerShell.Commands
{
    ...
    [CmdletExample(
Code = @"PS:> Add-SPOWebPartToWikiPage -ServerRelativePageUrl ""/sites/demo/sitepages/home.aspx"" -Path ""c:\myfiles\listview.webpart"" -Row 1 -Column 1",
Remarks = @"This will add the webpart as defined by the XML in the listview.webpart file to the specified page in the first row and the first column of the HTML table present on the page", SortOrder = 1)]
    [CmdletExample(
  Code = @"PS:> Add-SPOWebPartToWikiPage -ServerRelativePageUrl ""/sites/demo/sitepages/home.aspx"" -XML $webpart -Row 1 -Column 1",
