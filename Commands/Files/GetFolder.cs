...
{
    [Cmdlet(VerbsCommon.Get, "SPOFolder")]
    ...
    [CmdletExample(
        Code = @"PS:> Get-SPOFolder -RelativeUrl ""Shared Documents""",
        Remarks = "Returns the folder called 'Shared Documents' which is located in the root of the current web",
        SortOrder = 1
        )]
    [CmdletExample(
        Code = @"PS:> Get-SPOFolder -RelativeUrl ""/sites/demo/Shared Documents""",
        Remarks = "Returns the folder called 'Shared Documents' which is located in the root of the current web",
        SortOrder = 1
        )]
    [CmdletRelatedLink(
        Text = "Ensure-SPOFolder", 
