...
namespace SharePointPnP.PowerShell.Commands.Provider
{
    public class SPODriveParameters
    {
        ...
        [Parameter(HelpMessage = "Timeout for cachning item (files and folders) in milliseconds. Default: 1000 (1 second).")]
        public int ItemCacheTimeout { get; set; }

        [Parameter(HelpMessage = "Timeout for cachning webs in milliseconds. Default: 600000 (10 minutes).")]
