...
namespace SharePointPnP.PowerShell.Commands
{
    ...
    [CmdletExample(Code = @"PS:> Uninstall-PnPAppInstance -Identity AppTitle -force", Remarks = "Uninstalls the app instance with the ID 'AppTitle' and do not ask for confirmation", SortOrder = 4)]
