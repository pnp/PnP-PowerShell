...
namespace SharePointPnP.PowerShell.Commands
{
    ...
    [CmdletExample(Code = @"PS:> Uninstall-PnPAppInstance -Identity $appinstance", Remarks = "Uninstalls the app instance which was retrieved with the command Get-SPOAppInstance", SortOrder = 1)]
