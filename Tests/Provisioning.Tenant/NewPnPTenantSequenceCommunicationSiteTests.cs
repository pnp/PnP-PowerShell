    ...
    public class NewTenantSequenceCommunicationSiteTests
    {
        ...
        public void NewPnPTenantSequenceCommunicationSiteTest()
        {
            using (var scope = new PSTestScope(true))
            {
				...
				var siteDesignId = "";
				var hubSite = "";
				var allowFileSharingForGuestUsers = "";
				var templateIds = "";

                var results = scope.ExecuteCommand("New-PnPTenantSequenceCommunicationSite",
					...
					new CommandParameter("AllowFileSharingForGuestUsers", allowFileSharingForGuestUsers),
