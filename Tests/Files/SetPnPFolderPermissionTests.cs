    ...
    public class SetFolderPermissionTests
    {
        ...
        public void SetPnPFolderPermissionTest()
        {
            using (var scope = new PSTestScope(true))
            {
				...
				// From Cmdlet Help: The ID, Title or Url of the list the folder is part of
				var list = "";
				// This is a mandatory parameter
				// From Cmdlet Help: The ID of the folder, the server relative URL to the folder or actual Folder object
				var identity = "";
				// This is a mandatory parameter
				var group = "";
				// This is a mandatory parameter
				...
				var clearExisting = "";
				// From Cmdlet Help: Inherit permissions from the parent, removing unique permissions
				var inheritPermissions = "";
				// From Cmdlet Help: Update the folder permissions without creating a new version or triggering MS Flow.
				var systemUpdate = "";
